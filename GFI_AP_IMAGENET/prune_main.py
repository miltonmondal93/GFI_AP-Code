...
r_count = 2 #4
layer_lr_init = 0.01 #0.002 ##base learning rate for each layer retraining (0.01 by default)
...
f_epochs = 12 #40 #80
f_lr_init = [0.0004] #[0.004]  #[0.1]
lr_change_freq = 1 #5 #10
lr_divide_factor_init = 1.4 #1.8
...
if s == 0:
    ...
    for p_per in range(p_start,p_end,p_gap):
        ...
        lr_divide_factor = lr_divide_factor_init*(1+((2*(ct+1))/100))
